...
public class GetProjectInfoTool(ILogger<GetProjectInfoTool> logger, UnityWebSocketService webSocketService)
{
    ...
    [McpServerTool]
    [Description("Get Unity project metadata: name, version, active scene, paths, and play state.")]
    [return: Description("Project info including name, Unity version, scene, and editor state")]
